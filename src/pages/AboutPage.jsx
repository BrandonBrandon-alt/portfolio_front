...
const AboutPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero / Overview panel */}
      <motion.div
        className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 mb-16 sm:mb-20 panel-holo p-6 sm:p-8 rounded-2xl relative overflow-hidden group"
        data-variant="blue"
      ...
      >
        {/* Badges */}
        <div className="absolute top-3 sm:top-4 left-3 sm:left-4 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 z-20">
          <span className="text-[9px] sm:text-[10px] font-mono tracking-wider text-[var(--color-accent-jedi-green)] bg-[var(--color-accent-jedi-green)]/10 px-2 py-1 rounded border border-[var(--color-accent-jedi-green)]/30">
            PROFILE OVERVIEW
          </span>
          <span className="text-[9px] sm:text-[10px] font-mono tracking-wider text-[var(--color-accent-jedi-blue)]/70">
            LIVE
          </span>
        </div>
        ...
        >
          <div
            className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 holo-frame"
            data-corners="on"
          >
            ...
            <div className="relative z-10 w-full h-full rounded-full border-4 border-[var(--color-accent-jedi-green)]/30 shadow-2xl bg-gradient-to-br from-[var(--color-accent-jedi-blue)]/20 to-[var(--color-accent-jedi-green)]/20 flex items-center justify-center backdrop-blur-sm hidden">
              <div className="text-center">
                <div className="w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-2 rounded-full bg-[var(--color-accent-jedi-blue)]/30 flex items-center justify-center">
        ...
        <motion.div
          className="flex-1 text-center lg:text-left space-y-3 sm:space-y-4 mt-4 lg:mt-0"
          variants={itemVariants}
        >
          <motion.p
      ...
      <motion.section
        className="mb-12 sm:mb-16 relative panel-holo p-6 sm:p-8 rounded-2xl overflow-hidden"
        data-variant="green"
        variants={itemVariants}
      >
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-display font-bold mb-3 sm:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-accent-jedi-green)] to-[var(--color-accent-jedi-blue)] tracking-wide relative inline-block">
        ...
        <motion.p
          className="text-sm sm:text-base leading-relaxed text-[var(--color-text-primary)]/85 mb-3 sm:mb-4"
          variants={itemVariants}
        >
      ...
      >
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-display font-bold mb-3 sm:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-accent-jedi-blue)] to-[var(--color-accent-jedi-green)] tracking-wide relative inline-block">
